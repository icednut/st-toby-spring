...
import list6_1.user.config.AppConfig;
...
import static list6_1.user.service.UserServiceImpl.MIN_LOGCOUNT_FOR_SILVER;
import static list6_1.user.service.UserServiceImpl.MIN_RECOMMEND_FOR_GOLD;
